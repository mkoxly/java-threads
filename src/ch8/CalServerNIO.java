...
public class CalServerNIO {
	private static BaseExpression BE = new BaseExpression();
    ...
    private void doWrite(SelectionKey sk) {
        ...
        try {
        	String exp = byteBufferToString(bb);
        	System.out.println("exp:"+exp);
        	String result = (String) BE.calculate(exp);
        ...
        // OP_WRITE.
        System.out.println("outq.size=:" + outq.size());
       /* if (outq.size() == 0) {
...
//            }
    ...
    public static void main(String[] args) {
    	CalServerNIO echoServer = new CalServerNIO();
        try {
